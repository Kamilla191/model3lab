    ...
    public static void generation() {
        ...
        for (int i = 0; i < NUM_BANKS; i++) {
            ...
            for (int j = 0; j < NUM_OFFICES; j++, idOffice++, idAtm++) {
                bankOfficeService.create(idOffice, "Отделение банка №" + (j + 1), bankService.read(idBank), "г. Белгород, ул. Победы " + (idOffice + 1), true, true, true, true, true, randomDouble(1000 + j* 3000, 10000 + j * 1500));
